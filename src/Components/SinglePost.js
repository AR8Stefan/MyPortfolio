...
export default function SinglePost() {
  ...
  return (
    <main className="burgundy-bg min-h-screen p-12">
      <article className="container mx-auto bg-white shadow-lg rounded-lg">
        <header className="relative ">
          <div className="absolute h-full w-full flex items-center justify-center p-8">
            <div className="bg-black bg-opacity-50 rounded p-12">
              <h1 className="karla text-3xl lg:text-6xl mb-4">
                {singlePost.title}
              </h1>
              <div className="flex justify-center text-offwhite">
                ...
                />
                <p className="karla flex items-center pl-2 text-2xl">
                  {singlePost.name}
                </p>
              </div>
            </div>
